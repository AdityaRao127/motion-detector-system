...
![M5GO Kit](https://static-cdn.m5stack.com/resource/docs/products/core/m5go_v2.7/m5go_v2.7_02.webp)
...
5. Visit [Website](https://flow.m5stack.com/) and insert [main.py](https://github.com/AdityaRao127/motion-detector-system/blob/main/main.py) into the file.
...
6. Name the python file `main` if it's not already. Then download the [main.py](https://github.com/AdityaRao127/motion-detector-system/blob/main/main.py).

7. Change M5GO device into APP Mode -> Reset Device -> Go to Programs -> Select the `main.py` file.
...
PIR sensor detects the heat emitted by a person or object, and this detection signal is sent to the microcontroller, which then sends an email to the specified recipient.
